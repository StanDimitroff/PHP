<!--Write a PHP script CVGenerator.php which generates an HTML form like in the example below. When the information is submitted (via Generate CV), the script should print out a simple table-like CV. Semantic HTML is required. Styling is not required.-->
...
<form action="result.php" method="post">
    <fieldset>Personal Information <br/>
    ...
    <fieldset>Last Work Position <br/>
